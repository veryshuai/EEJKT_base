function [V,l_opt,my_flag] = val_loop_h(Q0,Q0_d,a,pi,mm)
%This function solves for the value function and optimal search intensity 
    ...
    % Options for solver
    options = optimset('Display','off','Jacobian','on','GradObj','on','GradConstr','on','TolX',tol/100/scl,'TolFun',tol/scl,'DerivativeCheck','off','maxiter',1000,'Algorithm','trust-region-reflective');
