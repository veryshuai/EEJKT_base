...
if cf_num ~= 9 % Don't waste time if we are doing no learning version of the model
    [lambda_f_orig,lambda_h_orig,pi_tilda_h_orig,pi_tilda_f_orig,c_val_h_orig,c_val_f_orig,flag_orig] = solve(mm);
end
...
switch cf_num
    ...
    case 3
        ...
        % Get policy and value functions
        [lambda_f_new,lambda_h_new,pi_tilda_h_new,pi_tilda_f_new,c_val_h_new,c_val_f_new,flag_new] = solve(mm);
