...
%      93.43344   1.01267  94.49897  -1.16316  22.91214   0.38119]; 
 ...
 X = [2.13888   2.41381   0.49448   0.27753   4.37090   0.97332  28.03347 ...
     11.71007   0.89051  11.30336   4.70664   6.65026   0.78802]; % fit: 8045737.16
...
pd_scale_scst = csvread('proposal_dist_scst.csv')
pd_scale_prof = csvread('proposal_dist_prof.csv')
pd_scale_per = csvread('proposal_dist_per.csv')
pd_scale_het = csvread('proposal_dist_het.csv')


chpf_scst = pd_scale_scst*chol(pf_scst); % [X(5),X(11),X(12)]
chpf_prof = pd_scale_prof*chol(pf_prof); % [X(2),X(3),X(4),X(10)]
chpf_per  = pd_scale_per*chol(pf_per);  % [X(1),X(8),X(9)]
chpf_het  = pd_scale_het*chol(pf_het); % [X(6),X(7),X(13)]
