...
% X = [-5.79756  -3.75520   0.23144   2.46214   1.88120  15.42601 0.38239  10.94623   1.38618  -1.26506  13.00126  -6.13549];
% X = [-2.80077  -3.13020   0.23144   3.75072   2.19370  15.42601 0.41289  10.33455   1.38565  -1.26506  13.00126  -6.13549];
...
% To exclude intercept of log-log regression, allow next line

    Data(11) = 0;
%   Model(11) = 0;
    error(11) = 0;
    
% To exclude variance of DANE-based X-D regression, allow next line

    Data(17) = 0;
%   Model(17) = 0;
    error(17) = 0;
    
    % To exclude market exit regression
    % block
    ...
    % To exclude variance of error in domestic AR1, allow next
    % block
